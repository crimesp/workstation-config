...
alias .git.remote.get-url.origin='git remote get-url origin'
alias .mvn.run='mvn spring-boot:run'
alias .sl.run='streamlit run'
alias .git.config.merge='git config pull.rebase false'
alias .mvn.spotless='mvn spotless:apply -DskipTests'
alias .cd.wiki='cd ~/git/wiki/cesa'
